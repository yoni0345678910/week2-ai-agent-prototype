...
RAG 파라미터 변화에 따른 답변 성능을 비교하기 위해 RFP 문서를 활용하여
동일한 평가 질문에 대해 반복 테스트를 수행했습니다.

각 질문별로 문서에서 확인할 수 있는 핵심 근거를 사전에 정의하고,
생성된 답변에 해당 근거가 얼마나 포함되었는지를 기준으로 정량 평가했습니다.

#### 평가 결과

| 실험 | Chunk Size | Chunk Overlap | k | 정량 평가 결과 |
|---|---:|---:|---:|---:|
| 초기 설정 |  |  |  |  |
| 1차 조정 |  |  |  |  |
| 2차 조정 |  |  |  |  |
